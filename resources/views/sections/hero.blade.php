        ...
        <div class="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div class="lg:w-1/2 text-center lg:text-left">
                ...
                <span class="inline-block px-4 py-1.5 mb-6 text-sm font-bold tracking-wider text-primary uppercase bg-baby-pink/30 rounded-full">
                    Pendamping Siklus Menstruasi
                </span>

                {{-- Main Heading --}}
                <h1 class="font-display text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
                    Pantau dan pahami
                    <span class="text-primary">siklus menstruasi</span>
                    dengan lebih mudah.
                </h1>

                {{-- Description --}}
                <p class="text-lg lg:text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-lg mx-auto lg:mx-0">
                    Catat riwayat siklusmu, dapatkan perkiraan jadwal menstruasi berikutnya,
                dan persiapkan aktivitas harian dengan lebih nyaman dan terencana.
                </p>

                {{-- Call to Action Buttons --}}
                <div class="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                    {{-- Primary CTA --}}
                   <a href="#cta" class="bg-primary text-white px-10 py-4 rounded-full font-bold text-lg hover:opacity-90 transition-all shadow-xl shadow-primary/30 flex items-center gap-2">
                        <span class="material-symbols-outlined">download</span>
                        Download Now
                    </a>

                    {{-- Secondary CTA --}}
                    <a href="#about" class="px-10 py-4 rounded-full font-bold text-lg border-2 border-primary text-primary hover:bg-primary/5 transition-all">
                        Learn More
                    </a>
                </div>
            </div>
