    ...
    <div class="flex h-screen overflow-hidden">
        <aside class="w-72 flex-shrink-0 bg-sidebar-pink flex flex-col border-r border-rose-100">
            ...
            <nav class="flex-1 px-6 space-y-2 overflow-y-auto">
                <a class="flex items-center gap-3 px-4 py-3 text-slate-600 hover:bg-rose-100 hover:text-primary rounded-xl transition-all"
                    href="#">
            ...
            <div class="p-6 border-t border-rose-100 space-y-2">
                <a class="flex items-center gap-3 px-4 py-3 bg-primary text-white rounded-xl transition-all shadow-sm"
                    href="#">
                    <span class="material-symbols-outlined">settings</span>
                    <span class="font-medium">Pengaturan</span>
                </a>
                <a class="flex items-center gap-3 px-4 py-3 text-rose-500 hover:bg-rose-100 rounded-xl transition-all"
                    href="#">
                ...
                <div class="flex items-center gap-6">
                    <div class="relative">
                        ...
                        <input
                            ...
                            placeholder="Cari pengaturan..." type="text" />
                    </div>
            ...
            <main class="flex-1 overflow-y-auto bg-white p-10">
                <div class="max-w-5xl mx-auto">
                    <div class="flex gap-8 border-b border-rose-100 mb-8">
                        <button
                            class="pb-4 px-2 border-b-2 border-primary text-primary font-bold text-sm transition-all">Profil
                            Admin</button>
                        <button
                            class="pb-4 px-2 border-b-2 border-transparent text-slate-400 hover:text-primary font-medium text-sm transition-all">Keamanan</button>
                        <button
                            class="pb-4 px-2 border-b-2 border-transparent text-slate-400 hover:text-primary font-medium text-sm transition-all">Konfigurasi
                            Sistem</button>
                    </div>
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        <div class="lg:col-span-2 space-y-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label class="text-xs font-bold text-slate-500 uppercase tracking-wider">Nama
                                            Lengkap</label>
                                        <input
                                            class="w-full border-rose-100 bg-rose-50/20 rounded-xl focus:ring-primary focus:border-primary text-sm p-3"
                                            type="text" value="Sarah Jenkins" />
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-xs font-bold text-slate-500 uppercase tracking-wider">Alamat
                                            Email</label>
                                        <input
                                            class="w-full border-rose-100 bg-rose-50/20 rounded-xl focus:ring-primary focus:border-primary text-sm p-3"
                                            type="email" value="sarah.jenkins@mirai-health.com" />
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-xs font-bold text-slate-500 uppercase tracking-wider">Nomor
                                            Telepon</label>
                                        <input
                                            class="w-full border-rose-100 bg-rose-50/20 rounded-xl focus:ring-primary focus:border-primary text-sm p-3"
                                            type="text" value="+62 812 3456 7890" />
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-xs font-bold text-slate-500 uppercase tracking-wider">Role
                                            Jabatan</label>
                                        <input
                                            class="w-full border-rose-50 bg-slate-50 rounded-xl text-slate-400 text-sm p-3 cursor-not-allowed"
                                            readonly="" type="text" value="Senior System Administrator" />
                                    </div>
                                </div>
                            </section>
                            <section>
                                ...
                                <div class="space-y-4">
                                    <label
                                        class="flex items-center justify-between p-4 bg-rose-50/30 border border-rose-100 rounded-xl cursor-pointer hover:bg-rose-50/50 transition-all">
                                        <div class="flex items-center gap-3">
                                            <span class="material-symbols-outlined text-primary">mail</span>
                                            <span class="text-sm font-medium text-slate-700">Laporan Mingguan via
                                                Email</span>
                                        </div>
                                        <input checked=""
                                            class="w-10 h-5 rounded-full text-primary focus:ring-primary/20 border-rose-200"
                                            type="checkbox" />
                                    </label>
                                    <label
                                        class="flex items-center justify-between p-4 bg-rose-50/30 border border-rose-100 rounded-xl cursor-pointer hover:bg-rose-50/50 transition-all">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span class="text-sm font-medium text-slate-700">Peringatan Kegagalan
                                                Sistem Real-time</span>
                                        </div>
                                        <input checked=""
                                            class="w-10 h-5 rounded-full text-primary focus:ring-primary/20 border-rose-200"
                                            type="checkbox" />
                            ...
                            <div class="pt-6 flex gap-4">
                                <button
                                    class="bg-primary text-white px-8 py-3 rounded-xl font-bold text-sm shadow-md shadow-primary/20 hover:bg-rose-600 transition-all">
                                    Simpan Perubahan
                                </button>
                                <button
                                    class="bg-white text-slate-500 border border-slate-200 px-8 py-3 rounded-xl font-bold text-sm hover:bg-slate-50 transition-all">
                                    Batalkan
                                </button>
                            </div>
                        </div>
                        <div class="space-y-8">
                            <div class="bg-sidebar-pink/50 border border-rose-100 p-8 rounded-2xl text-center">
                                <div class="relative w-32 h-32 mx-auto mb-6">
                                    <img alt="Admin Profile Big"
                                        class="w-full h-full object-cover rounded-3xl border-4 border-white shadow-lg"
                                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuBd5O7bCkEck3mAE5X76r1tzFmTi7vKs91dKvImYSOPIZA6ffLRGC-STIkifTXUM4dKJ9Nvbv-zKUBcIhJS77ZU5eq6mfSxCy9V3P37-VgdAB4HStRt-tHkMDuxTXsSe8QJZPEJk9yiTrOOa_RBPQ97S-m-R8PDN0JC77F2SEUSSf8FGtzZsGatzd963VH6Zt8vP_uYyN737GksaTEQtNYrn0XDnRS_nOBBStzyRCHfmx8K9P9UxcAPPj9aSLEa-G6uVC8w_qVHKdzY" />
                                    <button
                                        class="absolute -bottom-2 -right-2 bg-primary text-white p-2 rounded-xl shadow-lg border-2 border-white hover:scale-105 transition-transform">
                            ...
                            <div class="bg-white border border-rose-100 p-8 rounded-2xl shadow-sm">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Versi
                                            Backend</p>
                                        <p class="text-sm font-semibold text-slate-700">v2.4.8-stable</p>
                                    </div>
                                    <div>
                                        <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Waktu
                                            Server</p>
